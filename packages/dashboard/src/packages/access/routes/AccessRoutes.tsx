...
import {useGetAccessPagePaths} from "@packages/access/routes/hooks/useGetAccessPagePaths";
import GlobalServiceEndpointsListPage
    from "@packages/access/pages/globalServiceEndpointsList/GlobalServiceEndpointsListPage";
import StructurePluginTypesPage from "@packages/access/pages/structurePluginTypes/StructurePluginTypesPage";

const AccessRoutes = () => {

    const dashboardServicePagePaths = useGetDashboardServicePagePaths()
    const pagePaths = useGetAccessPagePaths()
    ...
    return (
        <Routes>
            ...
            <Route element={<GlobalServiceEndpointsListPage/>} path={pagePaths.globalServiceEndpoints}/>
            <Route element={<StructurePluginTypesPage/>} path={pagePaths.structurePluginTypes}/>
        </Routes>
