...
import {useGetActionsLoggerPagePaths} from "@packages/actionsLogger/routes/hooks/useGetActionsLoggerPagePaths";
...
import ActionsLoggerListPage from "@packages/actionsLogger/pages/actionsLoggerList/ActionsLoggerListPage";

const ActionsLoggerRoutes = () => {

    const dashboardServicePagePaths = useGetDashboardServicePagePaths()
    const pagePaths = useGetActionsLoggerPagePaths()
    ...
    return (
        <Routes>
            ...
            <Route element={<ActionsLoggerListPage/>} path={pagePaths.actionsLoggerList}/>
        </Routes>

    )
};

export default ActionsLoggerRoutes;