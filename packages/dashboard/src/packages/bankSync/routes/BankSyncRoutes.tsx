...
import {useGetBankSyncPagePaths} from "@packages/bankSync/routes/hooks/useGetBankSyncPagePaths";
import BankSyncParsingTypesPage from "@packages/bankSync/pages/bankSyncParsingTypes/BankSyncParsingTypesPage";

const BankSyncRoutes = () => {

    const dashboardServicePagePaths = useGetDashboardServicePagePaths()
    const pagePaths = useGetBankSyncPagePaths()
    ...
    return (
        <Routes>
            ...
            <Route element={<BankSyncParsingTypesPage/>} path={pagePaths.parsingTypes}/>
        </Routes>

    )
};

export default BankSyncRoutes;