import { ModelSqlColumns } from "../..";
import { ConfigModelSql, CreateAttrRowModelSql, FindOptionUpdateManyRowModelSql, FindOptionUpdateRowModelSql, OptionsPaginationModelSql, PropsCountModelSql, PropsDeleteRowModelSql, PropsFindAllModelSql, PropsFindByPkModelSql, PropsFindOneModelSql, ResultFindAllModelSql, ResultFindByPkModelSql, ResultFindOneModelSql, RowWithAggregatesModelSql, RowWithBaseFieldsAndAttributesModelSql, RowWithBaseFieldsModelSql, RowWithIncludeModelSql, SqlAggregate, SqlAssociation, SqlAssociationRow } from "../../core";
import { PaginationQueryParams, PaginationValues } from "../../../pagination";
export interface IModelSql<Row extends object, Includes extends Record<string, SqlAssociation<any>> = {}, RowPrimaryKey extends string = 'id', RowDateAddKey extends (string | null) = 'date_add', RowDateUpdateKey extends (string | null) = 'date_update'> {
    ...
    update(row: Partial<Row>, options: FindOptionUpdateRowModelSql<Row, RowPrimaryKey, RowDateAddKey, RowDateUpdateKey, undefined>): Promise<void>;
