...
export declare class DbConnectionNoSqlFiltersBuilder {
    buildFilters<Row extends object, RowDateAddKey extends (string | null) = 'date_add', RowDateUpdateKey extends (string | null) = 'date_update'>({ where, filters, }: {
