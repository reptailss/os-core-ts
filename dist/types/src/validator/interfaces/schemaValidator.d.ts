import { SchemaValidatorType, ValidateResult } from "../core";
export interface SchemaValidator<Value = any> {
    readonly _value: Value;
    optional(): SchemaValidator<Value | undefined>;
    refine(checkCb: (arg: Value) => boolean, message?: string): SchemaValidatorRefineEffect<Value>;
    refine<Value>(checkCb: (arg: Value) => arg is Value, message?: string): SchemaValidatorRefineEffect<Value>;
