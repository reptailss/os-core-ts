import { NoSqlRepositoryFindAllOptions, NoSqlRepositoryFindOptions, NoSqlRepositoryPaginationOptions, NoSqlRow } from "../../core";
import { CreateEntity, Entity, UpdateEntity } from "../../../entity";
import { PaginationQueryParams, PaginationValues } from "../../../pagination";
export interface INoSqlRepository<ClassEntity extends object> {
