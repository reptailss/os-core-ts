...
exports.DbConnectionNoSqlFiltersBuilder = void 0;
...
class DbConnectionNoSqlFiltersBuilder {
    constructor() {
    ...
    buildFilters({ where, filters, }) {
        if (!where && !filters) {
            return {};
        }
        if (!filters && where) {
            return this.parseWhereParamsToOpMongoose(where);
        }
        if (!where && filters) {
            return filters;
        }
        return Object.assign(Object.assign({}, this.parseWhereParamsToOpMongoose(where)), filters);
    }
...
exports.DbConnectionNoSqlFiltersBuilder = DbConnectionNoSqlFiltersBuilder;
//# sourceMappingURL=DbConnectionNoSqlFiltersBuilder.js.map