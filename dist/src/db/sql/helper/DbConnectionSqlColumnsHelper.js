...
exports.DbConnectionSqlColumnsHelper = void 0;
const sequelize_1 = require("sequelize");
class DbConnectionSqlColumnsHelper {
    static transformEntityColumnsToSequelize(columns, dialect, options) {
        const newColumns = {};
        ...
        if (options === null || options === void 0 ? void 0 : options.dateAdd) {
            newColumns[options.dateAdd] = this.entityColumnToSequelizeColumn({
                type: 'DATETIME',
                defaultValue: 'CURRENT_TIMESTAMP',
            }, dialect);
        }
        if (options === null || options === void 0 ? void 0 : options.dateUpdate) {
            newColumns[options === null || options === void 0 ? void 0 : options.dateUpdate] = this.entityColumnToSequelizeColumn({
                type: 'DATETIME',
                defaultValue: 'CURRENT_TIMESTAMP',
            }, dialect);
        }
        for (const columnKey in columns) {
            newColumns[columnKey] = this.entityColumnToSequelizeColumn(columns[columnKey], dialect);
        }
        return newColumns;
    }
    static entityColumnToSequelizeColumn(column, dialect) {
        switch (column.type) {
            case 'INTEGER': {
                return {
    ...
    static transformDescribeSequelizeColumnToEntity(column) {
    ...
    static getCurrentTypeColumnSequelize(column, dialect) {
        var _a, _b, _c, _d, _e;
        switch (column.type) {
            case 'INTEGER': {
            ...
            case 'TEXT': {
                if (((_e = column === null || column === void 0 ? void 0 : column.options) === null || _e === void 0 ? void 0 : _e.length) && dialect !== 'sqlite') {
...
exports.DbConnectionSqlColumnsHelper = DbConnectionSqlColumnsHelper;
//# sourceMappingURL=DbConnectionSqlColumnsHelper.js.map