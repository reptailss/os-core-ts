...
exports.DbConnectionSqlQueryBuilder = void 0;
...
class DbConnectionSqlQueryBuilder {
    ...
    buildWhere(where, clientWhere) {
        ...
        return Object.assign(Object.assign({}, this.parseWhereParamsToOpSequelize(clientWhere)), this.parseFiltersToOpSequelize(where));
    }
    ...
    getIncludes(incl) {
        ...
        for (const inc of incl) {
            ...
            res.push({
                ...
                as: inc.modelKey,
                require: inc.require,
                where: this.buildWhere(inc.where, inc.clientWhere),
            });
        }
        return res;
    }
...
exports.DbConnectionSqlQueryBuilder = DbConnectionSqlQueryBuilder;
//# sourceMappingURL=DbConnectionSqlQueryBuilder.js.map