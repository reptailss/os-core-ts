...
exports.PtpCoreAuthService = void 0;
const _appError_1 = require("../../appError");
const _services_1 = require("../../services");
class PtpCoreAuthService {
    static async checkTokenAndGetUserInfo({ token, roles, }) {
        const response = await _services_1.OsCorePtpCoreUsersService.introspect(token);
...
exports.PtpCoreAuthService = PtpCoreAuthService;
//# sourceMappingURL=PtpCoreAuthService.js.map