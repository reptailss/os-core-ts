...
> extends SchemaValidator<Value> {
    ...
    >(
        schema: ObjectValidator<R, Catchall, NewValue> | SchemaValidator<NewValue> | SchemaValidatorRefineEffect<NewValue>
    ): ObjectValidator<
...
export type ObjectValueSchemaValidator = {[k: string]: SchemaValidator | SchemaValidatorRefineEffect};
...
type CatchallOutput<T extends SchemaValidator> = SchemaValidator extends T ? unknown : {[k: string]: T['_value']};

export type ObjectResultTypeValidator<
    Shape extends ObjectValueSchemaValidator,
    Catchall extends SchemaValidator,
> = flatten<
