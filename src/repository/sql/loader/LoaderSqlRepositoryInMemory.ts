...
export class LoaderSqlRepositoryInMemory implements ILoaderSqlRepository {
    
    public async dynamicByDomain<ClassEntity extends object>(props: {
        domain: string
        entity: ClassEntity
        tableName: string
        ...
        const repository = new SqlRepositorySqlite(
            dbConnection,
            props.tableName,
            props.entity,
            props.indexes,
    ...
    public async dynamicDbConfigByLegalEntityId<ClassEntity extends object>(props: {
    ...
    >(props: {
        ...
        const repository = new SqlRepositorySqlite<ClassEntity, Includes>(
            props.dbConnection,
            props.tableName,
            props.entity,
            props.indexes,
