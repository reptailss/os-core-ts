...
export type SqlAssociation<ReferenceClassEntity extends object, RootClassEntity extends object = any> =
    SqlAssociationBelongsTo<ReferenceClassEntity, RootClassEntity>
    | SqlAssociationHasMany<ReferenceClassEntity>
    | SqlAssociationHasOne<ReferenceClassEntity>

export type SqlAssociationBelongsTo<
    ReferenceClassEntity extends object,
    RootClassEntity extends object
> = {
