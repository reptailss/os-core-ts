import {AppError, AppErrorKey, AppErrors, ErrorValue} from '@appError'
import {ErrorResult} from '@responseFormat'

const APP_ERROR_CODES: AppErrors<string> = {
...
const APP_ERROR_DESCRIPTIONS: AppErrors<string> = {
...
const APP_STATUS_CODES: AppErrors<number> = {
...
export class AppErrorHelper {
    ...
    static getAppErrorCodeAndStatus({
                                        errorCode,
                                        statusCode,
                                        errorKey,
                                    }: {
    ...
    static getErrorMessageByErrorKey(errorKey: AppErrorKey) {
