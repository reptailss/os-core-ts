...
import {
    ...
    SqlAssociationRow,
    SqlFilters,
    OrderWithSqlAggregate,
    RowWithAggregatesModelSql,
    RowWithIncludeModelSql,
} from '@model/core'

export type RowWithBaseFieldsModelSql<
    Row,
...
> =
    ReturnAttributes extends Array<keyof RowWithBaseFieldsModelSql<
            ...
            RowDateUpdateKey
        >> ?
        Pick<RowWithBaseFieldsModelSql<
            Row,
            RowPrimaryKey,
            RowDateAddKey,
            RowDateUpdateKey
...
export type KeysRowBaseFieldsModelSql<
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update'
> = keyof RowBaseFieldsModelSql<
    RowPrimaryKey,
    RowDateAddKey,
    RowDateUpdateKey
>

export type CreateAttrRowModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
> =
    Omit<Row, KeysRowBaseFieldsModelSql<
        RowPrimaryKey,
        RowDateAddKey,
        RowDateUpdateKey
    >>
...
export type PropsDeleteRowModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update'
...
export type PropsCountModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
...
export type FindOptionUpdateRowModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
...
export type FindOptionUpdateManyRowModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
    HasReturning extends boolean = boolean
> = {
    where?: WhereParams<RowWithBaseFieldsModelSql<
        Row,
        RowPrimaryKey,
...
export type ResultFindOneModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
...
>
    =
    RowWithAggregatesModelSql<RowWithBaseFieldsAndAttributesModelSql<
        Row,
        RowPrimaryKey,
        RowDateAddKey,
        RowDateUpdateKey,
...
export type PropsFindByPkModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
...
export type PropsFindAllModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
...
> = {
    ...
    filters?: SqlFilters<RowWithBaseFieldsModelSql<
        ...
        RowDateUpdateKey
    >>,
    order?: OrderParams<RowWithBaseFieldsModelSql<
        Row,
        RowPrimaryKey,
        RowDateAddKey,
        RowDateUpdateKey
...
export type ResultFindAllModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null)  = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
...
export type OptionsPaginationModelSql<
    Row extends object,
    RowPrimaryKey extends string = 'id',
    RowDateAddKey extends (string | null) = 'date_add',
    RowDateUpdateKey extends (string | null) = 'date_update',
