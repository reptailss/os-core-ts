...
import {KeysRowBaseFieldsModelSql} from '@model/core'

export type ModelSqlColumn<Row, Value> =
    ModelSqlColumnInteger |
    ModelSqlColumnBigint |
    ModelSqlColumnFloat |
    ModelSqlColumnBoolean |
...
> = {
    [K in keyof Omit<Row, KeysRowBaseFieldsModelSql<
        RowPrimaryKey,
        RowDateAddKey,
        RowDateUpdateKey
    >>]: ModelSqlColumn<Row, Row[K]>;
