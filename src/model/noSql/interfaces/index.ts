...
> {
    ...
    destroy(props: PropsDeleteRowModelNoSql<
        Row,
        RowDateAddKey,
        RowDateUpdateKey
    >): Promise<number>,

    destroyMany(props: PropsDeleteManyRowsModelNoSql<
        Row,
        RowDateAddKey,
        RowDateUpdateKey
    >): Promise<number>,

    count(props?: PropsCountModelNoSql<
        Row,
        RowDateAddKey,
        RowDateUpdateKey
    >): Promise<number>
    ...
    findOne<ReturnAttributes extends Array<keyof RowWithBaseFieldsModelNoSql<
        Row,
        RowDateAddKey,
        RowDateUpdateKey
    >> | undefined = undefined>(
        options: PropsFindOneModelNoSql<
            Row,
            RowDateAddKey,
            RowDateUpdateKey,
            ReturnAttributes
    ...
    findByPk<ReturnAttributes extends Array<keyof RowWithBaseFieldsModelNoSql<
        Row,
        RowDateAddKey,
        RowDateUpdateKey
    >> | undefined = undefined>(
        key: number | string,
        options?: PropsFindByPkModelNoSql<
            Row,
            RowDateAddKey,
            RowDateUpdateKey,
            ReturnAttributes
